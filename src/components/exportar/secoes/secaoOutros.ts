            ...
            retorno.push(
                new Paragraph ({
                    ...
                    children: [
                        new TextRun({
                            bold: true,
                            text: 'Por competência legal, a descrição minuciosa do' + ((qtde > 1)?'s':'') +
                            ...
                            ((qtde > 1)?' de cada cadáver ':'') + ' será objeto de laudo pericial a ser expedido pelo Instituto Médico Legal desta Polícia Científica, após realização de exame necroscópico.'
                        }),
                    ],
                })
            );
